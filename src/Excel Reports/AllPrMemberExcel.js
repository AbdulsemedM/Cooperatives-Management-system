...
const AllPrMemberExcel = ({ toDate, data }) => {
  let i = 0;
  ...
  const wsData = [
    ...
    ["", "", `As of - `],
    [`Name of The Primary Cooperative - All PC`],
    [
      "No.",
      "Name of PC",
      "Name of the Member",
  ...
  const handleExportExcel = () => {
    writeFile(wb, "All Member for PC.xlsx", {
      bookType: "xlsx",
      bookSST: false,
    });
  };
...
export default AllPrMemberExcel;
