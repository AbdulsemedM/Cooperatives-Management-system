...
const SectorAndIndustryMemberExcel = ({ toDate, data }) => {
  // let data = [];
  let i = 0;
  ...
  const wsData = [
    ...
    ["", "", "Cooperatives data by Sector and Industry"],
    ["", "", `As of - `],
    [
      "No.",
  ...
  const handleExportExcel = () => {
    writeFile(wb, "Sector and Industry.xlsx", {
      bookType: "xlsx",
      bookSST: false,
    });
  };
...
export default SectorAndIndustryMemberExcel;
