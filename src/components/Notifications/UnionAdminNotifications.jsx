...
const UnionAdminNotifications = ({ unionID }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      await API.get(`/annualTurnOver/union/${unionID}`).then((res) => {
...
export default connect(mapStateToProps)(UnionAdminNotifications);
